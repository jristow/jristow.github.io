...
class GatsbyReporter extends _react.default.Component {
  ...
  render() {
    ...
    }, msg.text)))), _react.default.createElement(_ink.Box, {
      flexDirection: "column",
      marginTop: 1
    }, showProgress && Object.keys(this.state.activities).map(activityName => _react.default.createElement(_activity.default, (0, _extends2.default)({
      key: activityName,
      name: activityName
